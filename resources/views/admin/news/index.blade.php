...
@section('content')
    ...
    <div class="alert alert-success d-none">
        <span>News Deleted Successfully.</span>
    </div>
            ...
            <table class="m-datatable" id="html_table" width="100%">
                ...
                @foreach($news as $news)
                    <tr id="item-{{ $news->id }}">
                        ...
                        <td>
                            {{$news->approval==0? 'not approve': 'approve'}}
                        </td>
                        <td>
                            <a href="{{route('editNewsForm',[$news->id])}}"
                               class="btn btn-outline-brand active">
                                Edit
                            </a>
                            <a
                                    href="{{ route('listComments',['news' => $news->id]) }}"
                            ...
                            <button type="button" class="btn btn-outline-danger active delete-modal" data-toggle="modal"
                                    data-id="{{ $news->id }}" data-target="#m_modal_4">
                                Delete
                            </button>
        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-primary delete-news btn-danger" id="footer_action_button">
                        Delete
                    </button>
                </div>
            </div>
...
@section('scripts')
    ...
    <script>
        ...
        $('.modal-footer').on('click', '.delete-news', function () {
