        ...
        <div class="d-flex align-items-center">
            <div class="mr-auto">
                ...
                <ul class="m-subheader__breadcrumbs m-nav m-nav--inline">
                    ...
                    <li class="m-nav__item">
                        <a href="{{route('editNewsForm',['news'=>$news->id])}}" class="m-nav__link">
											<span class="m-nav__link-text">
												Edit News
											</span>
                        </a>
...
@section('content')
    ...
    <div class="m-portlet">
        ...
        <form class="m-form m-form--fit m-form--label-align-right m-form--group-seperator-dashed" method="post"
              ...
              action="{{route('updateNews',['news'=>$news->id  ])}}">
                    ...
                    <div class="col-lg-6">
                        ...
                        <div class="col-lg-9 col-md-9 col-sm-12">
                                    <textarea name="description" class="form-control" data-provide="markdown"
                                              rows="10">{{old('description')?old('description'):$news->description}}</textarea>
                        </div>
                                ...
                                <div class="mt-radio-list">
                                    <label class="mt-radio mt-radio-outline">
                                        <input type="radio" name="approval" id="yes"
                                               value="1" @if($news->approval==1) checked @endif> yes
                                        <span></span>
                                    </label>
                                    <label class="mt-radio mt-radio-outline">
                                        <input type="radio" name="approval" id="no"
                                               value="0" @if($news->approval==0) checked @endif> no
                                        <span></span>
                                    </label>
                                </div>
                            </div>
